A dog walks into a room. There's a thing in there with it — a small wheeled object, vaguely box-shaped, no face, no fur, no tail. Call it a UMO: Unidentified Moving Object, the technical term used by the [researchers at Eötvös Loránd University](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0072727) in Budapest, who have been running this experiment, in various forms, for over a decade.
...
Now ask: how could such a system form *its own* conclusions about the world? People are working on this seriously. There's a research strand around getting models to update from their own outputs, integrate findings from their research back into their parameters, learn to learn. It's an attractive idea. It's also where you bump into a specific failure mode the field has named [*model autophagy disorder*](https://scitechdaily.com/could-ai-eat-itself-to-death-synthetic-data-could-lead-to-model-collapse/), or more colloquially, model collapse.
...
In 2019, [a research consortium](https://www.the-scientist.com/fish-and-bees-talk-with-help-from-robot-translators-65621) across several European universities ran an experiment too good not to mention. They placed a colony of honeybees in Graz, Austria, and a school of zebrafish in Lausanne, Switzerland. They put robotic agents in each environment — a stationary bee-robot that vibrated and emitted heat, a mobile fish-robot that flashed colors and moved its tail. The two robots were networked. The bees signaled to their robot, which signaled to the fish robot, which signaled to the fish, and back.
...
This is the part of Bateson the AI conversation rarely picks up on. For him, mind wasn't something inside a head — it was a property of certain feedback patterns, present wherever those patterns occur. Ecosystems, conversations, families, organizations. On that view, biohybrid systems aren't fake minds being engineered into existence; they're real instances of mind-as-pattern — [[journal:una-palabra-varias-aguas#^two-phenomena-one-word|two phenomena pretending to be one]], depending on the level of description — which would be a less surprising finding if we hadn't spent a few centuries assuming mind was a substance located in skulls. ^mind-as-relational-pattern
